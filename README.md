...
| :---- | :---- | :---- |
| 1 | Foundations of Data Science — Wrangling and Plotting | Importing, cleaning/wrangling, and visualizing data in R, without using an AI extensions (e.g. GitHub Copilot, `chattr`) to help generate code. |
